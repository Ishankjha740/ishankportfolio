...
export const CreativeWorks = () => {
  ...
  return (
    <section id="creative-works" ref={ref} className={`py-16 md:py-28 bg-paper ${className}`}>
      <div className="container max-w-6xl">
        ...
        <div className="reveal-fade stagger-2 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 auto-rows-[160px] sm:auto-rows-[190px] md:auto-rows-[220px] grid-flow-dense">
          {works.map((w, i) => (
